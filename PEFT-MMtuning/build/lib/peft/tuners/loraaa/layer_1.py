...
class LoraaaLayer(BaseTunerLayer):
    ...
    ### 这地方要改！！！
    adapter_layer_names = ("lora_A_1", "lora_B_1", "lora_embedding_A_1", "lora_embedding_B_1", "lora_A_2", "lora_B_2", "lora_embedding_A_2", "lora_embedding_B_2")
    ...
    def reset_lora_parameters(self, adapter_name):
        if adapter_name in self.lora_A_1.keys() or adapter_name in self.lora_A_2.keys():
    ...
    def scale_layer(self, scale: float) -> None:
        ...
        for active_adapter in self.active_adapters:
            ...
            if active_adapter not in self.lora_A_1.keys() or active_adapter not in self.lora_A_2.keys():
                continue

...
from .config import LoraaaConfig
from .gptq import QuantLinear
from .layer import Conv2d, Embedding, Linear, LoraaaLayer
...
-
    ...
    **Attributes**:
    ...
    def _check_new_adapter_config(self, config: LoraaaConfig) -> None:
        """
        ...
        for active_adapter in self.active_adapters:
            ...
            if bias == "all":
                ...
                for m in self.model.modules():
                    if isinstance(m, LoraaaLayer) and hasattr(m, "bias") and m.bias is not None:
    ...
    def set_adapter(self, adapter_name):
        for module in self.model.modules():
            if isinstance(module, LoraaaLayer):
                if module.merged:
    ...
    def add_weighted_adapter(
        ...
        for key in key_list:
            ...
            if isinstance(target, LoraaaLayer):
